...
public class JoueurImplTest extends UnicastRemoteObject implements Joueur
{
    ...
    public JoueurImplTest()throws RemoteException
    {
    }
    public JoueurImplTest(String nom)throws RemoteException
    {
        nomBlatte=nom;
    }
    public JoueurImplTest(Blatte b)throws RemoteException
    {
        this.blatte=b;
    }
